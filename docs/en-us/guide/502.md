---
description: "A Bad Gateway error happens when the PHP-FPM container fails to provide a valid response to the upstream server."
audience: customers
---
...
1. Access the cloud panel and head to your [Website↗](https://oscloud.nl/websites)
