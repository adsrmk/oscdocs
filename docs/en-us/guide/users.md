...
There are two available roles. Each has its own level of access:

| Role | Access |
| --- | --- |
| **Super Administrator** | Full access to all resources within the account — emails, integrations, logs, and all associated websites. |
...
1. In the left sidebar, go to [**Users**](https://oscloud.nl/users).
...
Once invited, the user must click the link in the invitation email to set up their account. Invitations automatically expire after about <b>10 days</b>.
</div>
