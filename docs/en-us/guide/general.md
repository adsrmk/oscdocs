...
Keeping your site secure means keeping its software up to date. This section controls how WordPress handles core updates.

- **Update preferences** — Toggle automatic updates for **minor versions** (security patches and bug fixes) or **major releases**. The green badge shows whether your site is running the latest stable version.
...
If you're performing a redesign or critical updates, toggle **Maintenance Mode** on. Visitors will see a message letting them know the site is temporarily unavailable.
