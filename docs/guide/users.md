...
Er zijn twee beschikbare rollen, elk met een eigen toegangsniveau:

| Rol | Toegang |
| --- | --- |
| **Super Administrator** | Volledige toegang tot alle resources binnen het account — e-mails, integraties, logs en alle gekoppelde websites. |
...
1. Ga in de linkerzijbalk naar [**Gebruikers**](https://oscloud.nl/users).
2. Klik rechtsboven op **Gebruiker uitnodigen**.
3. Vul de gegevens van de gebruiker in.
4. Kies de juiste **rol**.
5. Klik op **Uitnodigen** om de uitnodiging te versturen.

<div class="warning custom-block" style="padding-top: 8px">
Na het verzenden moet de gebruiker via de link in de uitnodigingsmail het account instellen. Uitnodigingen verlopen automatisch na ongeveer <b>10 dagen</b>.
</div>
